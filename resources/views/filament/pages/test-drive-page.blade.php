                                ...
                                >
                                    ...
                                    <div class="flex items-start justify-between mb-3">
                                        ...
                                        <button 
                                            ...
                                            class="opacity-0 group-hover:opacity-100 relative z-20 p-1.5 text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition-all transform scale-90 group-hover:scale-100"
                                            title="Vista previa rápida"
                                        >
                                            <x-heroicon-m-eye class="w-4 h-4" style="width: 1rem; height: 1rem;" />
                                        </button>
                                    </div>
