...
class EventualDrills extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->heading('Simulacros Eventuales / No Programados')
            ->columns([
            ...
            ->actions([
                Action::make('iniciar')
                    ...
                    ->modalHeading('Iniciar Simulacro')
                    ->modalDescription(function ($record) {
                        $progress = "";
                        if ($record->activity) {
                            $progress = "Progreso actual: {$record->activity->ejecuciones_realizadas}/{$record->activity->veces_al_anio}.";
                        }
                        return "¿Estás seguro de que deseas iniciar este simulacro? $progress El estado cambiará a 'Ejecutado' o 'En Proceso' según corresponda.";
                    })
