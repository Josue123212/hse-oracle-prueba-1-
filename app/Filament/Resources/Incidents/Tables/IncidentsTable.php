                ...
                Action::make('executions')
                    ...
                    ->form(function ($record) {
                        ...
                        $getFields = function ($execution, $prefix = '') {
                            ...
                            $fields[] = Section::make('Detalles de Seguimiento')
                                ->schema([
                                    Grid::make(1)
                                        ->schema([
                                            Textarea::make($fieldName('data.acciones_realizadas'))
                                                ->label('Acciones Realizadas')
                                                ->default($getData('acciones_realizadas'))
                                                ->rows(3),
                                            Textarea::make($fieldName('data.resultado_investigacion'))
                                                ->label('Resultado de Investigación')
                                                ->default($getData('resultado_investigacion'))
                                                ->rows(3),
                                        ]),
                                ]);
