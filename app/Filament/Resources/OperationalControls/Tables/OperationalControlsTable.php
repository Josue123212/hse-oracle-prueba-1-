                ...
                Action::make('executions')
                    ...
                    ->form(function ($record) {
                        ...
                        $getFields = function ($execution, $prefix = '') {
                            ...
                            // Campos dinámicos de Control Operacional
                            $fields[] = Section::make('Medición del Control')
                                ->schema([
                                    Grid::make(2)
                                        ->schema([
                                            ...
                                            Select::make($fieldName('data.cumplimiento'))
                                                ->label('Cumplimiento')
                                                ->options([
                                                    'cumple' => 'Cumple',
                                                    'no_cumple' => 'No Cumple',
                                                ...
                                                ->default($getData('cumplimiento')),
                                            Textarea::make($fieldName('data.evidencia'))
                                                ->label('Evidencia / Comentarios')
                                                ->default($getData('evidencia'))
                                                ->rows(2)
                                                ->columnSpanFull(),
                                        ]),
                                ]);
